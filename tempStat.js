...
const gl_versionDate = "10.7.2024"
...
addUndefPlaceDataPeriod(cv_placeRogaskaSlatina, 1, 2010, 12, 2015); //tu vmes ni podatkov, vseeno pa ohranim eno lokacijo, le graf se tu vmes ne bo prikazoval
...
addAvgTempYear(cv_placeSkofjaLoka, 2024, 1, [0.5, 5.6, 8.3, 11.1, 15.1, 19.5]);
...
addAvgTempYear(cv_placeMariborVrbanskiPlato, 2024, 1, [1.1, 8, 9.2, 11.9, 15.6, 20.5]);
...
addAvgTempYear(cv_placeLjubljanaBezigrad, 2024, 1, [1.6, 7.6, 9.7, 12.7, 16.2, 21.2]);
...
addAvgTempYear(cv_placeNovoMesto, 2024, 1, [1.6, 8.2, 9.8, 12.6, 16, 21.1]);
...
addAvgTempYear(cv_placePostojna, 2024, 1, [2.3, 6.6, 7.8, 10.4, 13.8, 18.6]);
...
addAvgTempYear(cv_placeNovaGoricaBilje, 2024, 1, [3.8, 8.1, 10.3, 13.1, 17.2, 21.5]);
...
addAvgTempYear(cv_placeKredarica, 2024, 1, [-5.4, -3.1, -4, -1.2, 1.3, 6.7]);
...
addAvgTempYear(cv_placeSlovenjGradecSmartno, 2024, 1, [-1.2, 4.7, 7.8, 10.9, 14.3, 19.5]);
...
addAvgTempYear(cv_placeKrvavec, 2024, 1, [-1.8, 1.1, 0.9, 3.9, 6.5, 11.6]);
...
addAvgTempYear(cv_placeMurskaSobota, 2024, 1, [0.3, 7.3, 9.2, 12.8, 16.5, 21.3]);
...
addAvgTempYear(cv_placeCelje, 2024, 1, [0.1, 6.8, 8.8, 11.6, 15.4, 20.7]);
...
addAvgTempYear(cv_placeBabnoPolje, 2024, 1, [-1.3, 3.7, 5.5, 7.9, 12.2, 16.7]);
...
addAvgTempYear(cv_placePortorozLetalisce, 2024, 1, [5.6, 9, 11.3, 13.6, 17.8, 22.5]);
...
addAvgTempYear(cv_placeKocevje, 2024, 1, [0.7, 6.2, 7.8, 10.3, 14, 19.2]);
...
addAvgTempYear(cv_placeRatece, 2024, 1, [-2.5, 2.4, 5.1, 7.9, 11.8, 16.5]);
...
addAvgTempYear(cv_placeVojsko, 2024, 1, [-0.3, 4.6, 4.6, 7.7, 11.4, 15.8]);
...
addAvgTempYear(cv_placeBrnikLetalisce, 2024, 1, [-1, 4.9, 7.9, 10.6, 14.8, 19.6]);
...
addAvgTempYear(cv_placeBizeljsko, 2024, 1, [0.6, 8.1, 9.8, 12.6, 16.6, 21.4]);
...
addAvgTempYear(cv_placeMariborLetalisce, 2024, 1, [0.5, 7.3, 9.2, 12.3, 16.2, 21.1]);
...
addAvgTempYear(cv_placeLogatec, 2024, 1, [0.3, 5.5, 7, 9.6, 13.6, 18.3]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeTolmin, 2024, 1, [2.5, 6.8, 9.5, 12.3, 15.6, 20.1]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeVelenje, 2024, 1, [2.1, 7.4, 9.6, 12.5, 16.1, 20.9]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placePtuj, 2024, 1, [0.6, 7.6, 9.3, 12.5, 16.2, 20.8]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeAjdovscina, 2024, 1, [4.8, 8.4, 10.7, 13.5, 17.3, 21.2]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placeCrnomelj, 2024, 1, [1.9, 8.5, 10, 12.3, 16.4, 21.2]);
...
addAvgTempYear(cv_placeGodnje, 2024, 1, [4.6, 8.3, 9.7, 12.3, 15.9, 20.2]);
...
addAvgTempYear(cv_placeBovec, 2024, 1, [1.3, 5.4, 8.2, 11.2, 14, 18.7]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placeLitija, 2024, 1, [1.1, 6.7, 8.9, 11.6, 15.4, 20.1]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeLisca, 2024, 1, [0.6, 6, 6.2, 9.1, 12.1, 14.9]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeTrbovlje, 2024, 1, [1.4, 7.3, 9.2, 12.2, 15.7, 20.7]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeVelikeLasce, 2024, 1, [0.5, 6.1, 7.5, 10, 13.7, 18.8]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeIlirskaBistrica, 2024, 1, [2.8, 6.3, 8.5, 11, 14.5, 19]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placeRogaskaSlatina, 2024, 1, [1.9, 8.1, 9.6, 12.6, 16, 20.9]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeSkocjan, 2024, 1, [3.4, 7, 8.9, 11.4, 15.2, 19.5]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placeLesce, 2024, 1, [0.5, 5.5, 7.7, 10.3, 14, 18.6]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placeCerkljeObKrki, 2024, 1, [0.9, 7.9, 9.6, 12.7, 16.4, 21.3]); // 1488 1345 1488 1440 1488 1440
...
addAvgTempYear(cv_placeRogla, 2024, 1, [-1.8, 2.5, 2.1, 5.4, 8.2, 13]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeGornjiGrad, 2024, 1, [0.8, 6.3, 8.1, 10.8, 14.3, 19.1]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeJeruzalem, 2024, 1, [2.5, 9.2, 9.9, 13.3, 16.6, 20.9]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeTrebnje, 2024, 1, [1.1, 7.4, 9.2, 12, 15.5, 20.5]); // 4464 4033 4464 4320 4464 4320
...
addAvgTempYear(cv_placeMezica, 2024, 1, [-1.8, 3.8, 7.2, 10.2, 14.1, 18.6]); // 4464 4033 4464 4320 4464 4320
